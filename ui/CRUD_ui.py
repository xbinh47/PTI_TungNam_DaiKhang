...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CRUDMenu.setStyleSheet(u"border-radius:10px\n"
"")
...
"border-radius:10px")
        ...
        self.CRUDList = QScrollArea(self.widget_4)
        self.CRUDList.setObjectName(u"CRUDList")
        self.CRUDList.setStyleSheet(u"background-color:rgb(0, 0, 0)")
        self.CRUDList.setWidgetResizable(True)
        self.scrollAreaWidgetContents_3 = QWidget()
        self.scrollAreaWidgetContents_3.setObjectName(u"scrollAreaWidgetContents_3")
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 949, 559))
        self.CRUDList.setWidget(self.scrollAreaWidgetContents_3)

        self.verticalLayout_5.addWidget(self.CRUDList)
        ...
        self.logo.setGeometry(QRect(0, 20, 50, 50))
...
"")
        ...
        self.listBtn = QPushButton(self.centralwidget)
        self.listBtn.setObjectName(u"listBtn")
        self.listBtn.setGeometry(QRect(0, 80, 51, 50))
        ...
        self.CRUDButton = QToolButton(self.centralwidget)
        self.CRUDButton.setObjectName(u"CRUDButton")
        self.CRUDButton.setGeometry(QRect(0, 140, 51, 50))
