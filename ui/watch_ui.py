...
"background-color:rgb(255, 255, 255)")
        ...
        icon1 = QIcon()
        icon1.addFile(u"../img/right-from-bracket-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border-radius:10px")
        ...
        icon2 = QIcon()
        icon2.addFile(u"../img/volume-high-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"../img/pause-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
